export type RootStackParamList = {
  ...
  MyTicket: undefined;
  Message: undefined;
  Chat: { conversationId?: string; postTitle: string; postId?: string; postOwnerId?: string; postOwnerUserData?: any; postType?: string; postStatus?: string; foundAction?: string; postCreatorId?: string; hideClaimButton?: boolean };
...
export interface Post {
  ...
  resolvedAt?: string | Date | any; // Firebase timestamp or Date - when post was resolved
  status?: "pending" | "resolved" | "unclaimed" | "completed" | "deleted";
  ...
  originalStatus?: "pending" | "resolved" | "unclaimed" | "completed" | "deleted"; // Store the original status before moving to unclaimed or deleting
